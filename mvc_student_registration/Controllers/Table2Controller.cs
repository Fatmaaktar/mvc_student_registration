...
namespace Mvc_Ogrenci_Kayit.Controllers
{
    public class Table2Controller : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,Surname,Mail,Photo,Address")] Table2 table2)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,Surname,Mail,Photo,Address")] Table2 table2)
        {
            if (ModelState.IsValid)
            {
